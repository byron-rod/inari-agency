    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-6">
        <Card
          ...
          icon={<AceternityIcon order="Part One" />}
        ...
        <Card
          ...
          icon={<AceternityIcon order="Part Two" />}
          des="Once we agree on the plan, we'll start designing your website. Providing updates according to the agreed timeline."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          icon={<AceternityIcon order="Part Three" />}
          des="After testing and finalizing the website, we'll launch it and start the optimization process. We'll also provide you with a guide on how to manage and update your website."
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center
       dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[25rem] rounded-lg"
      style={{
        //   add these two
